...
from erpnext.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import (
    DEFAULT_MAPPERS,
)
...
def check_setup_wizard_not_completed():
    if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
        message = """NONA Supplier App can only be installed on a fresh site where the setup wizard is not completed.
...
def setup_log_settings():
    ...
    log_settings.append(
        "logs_to_clear", {"ref_doctype": "Repost Item Valuation", "days": 60}
    )
